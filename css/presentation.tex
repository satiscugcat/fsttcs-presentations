...
\label{sec:org95bd981}
\begin{frame}[label={sec:orgce48d0e}]{Acknowledgements}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org46638e6}]{SIMD and Vector Intrinsics}
...
\end{frame}
\begin{frame}[label={sec:org57dcbd4},fragile]{SIMD in Rust}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgaa767b7}]{Importance}
...
\label{sec:orgd18fe83}
\begin{frame}[label={sec:orga0b7fa9}]{Rust Docs}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgecb2d18}]{ARM Docs}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga091343},fragile]{panic!()}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orge64719d},fragile]{A Bug in the Rust Source????}
 \pause
...
\end{frame}
\begin{frame}[label={sec:orgbef1199}]{The Moral of the Story}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd90749b}]{Formal Verification}
...
\label{sec:orgdc19303}
\begin{frame}[label={sec:org88c412f}]{The Problem}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org68cc0ee}]{Rewrite it .. in Rust!}
\pause
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org83c8d4b}]{Model Generation}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc718358}]{Built-In Intrinsics}
\begin{center}
\includegraphics[width=.9\linewidth]{./simd.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgbc9df33}]{External Intrinsics}
\begin{center}
\includegraphics[width=.9\linewidth]{./extern.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org2857012}]{Defined Intrinsics}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orga47c70e}]{Hand-Written Models: Built-In}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4bf729a}]{Hand-Written Models: External}
\begin{center}
\includegraphics[width=.9\linewidth]{./handwritten.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org52dfe11}]{Generated Models: Defined}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org3ca7ea9}]{Testing!}
\begin{center}
\includegraphics[width=.9\linewidth]{./tests.png}
\end{center}
\end{frame}
\section{Results}
\label{sec:org46aff65}
\begin{frame}[label={sec:org40f811f}]{Acceptance of Solution by AWS}
\begin{center}
\includegraphics[width=.9\linewidth]{./aws.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org37f0a72}]{Finding a Bug in Rust}
\begin{center}
\includegraphics[width=.9\linewidth]{./pr.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org26f2306}]{Future Work}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org9d7d7a6}]{Concluding}

...
\label{sec:orgefbf53e}
\begin{frame}[label={sec:org0aa4f56}]{Acknowledgements}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org0731e5e}]{SIMD and Vector Intrinsics}
...
\end{frame}
\begin{frame}[label={sec:org53708fa},fragile]{SIMD in Rust}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org47d7ba3}]{Importance}
...
\label{sec:org0c5cb03}
\begin{frame}[label={sec:orgf566d0c}]{Rust Docs}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orge3395bd}]{ARM Docs}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org4b12621},fragile]{panic!()}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgbdd41a7},fragile]{A Bug in the Rust Source????}
 \pause
...
\end{frame}
\begin{frame}[label={sec:orgc7e5229}]{The Moral of the Story}
...
\label{sec:org0a0717d}
\begin{frame}[label={sec:orgb7cc308}]{The Problem}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org4a6783f}]{Rewrite it .. in Rust!}
\pause
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orge995e21}]{Model Generation}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1a7c11a}]{Built-In Intrinsics}
\begin{center}
\includegraphics[width=.9\linewidth]{./simd.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd1e8cc8}]{External Intrinsics}
\begin{center}
\includegraphics[width=.9\linewidth]{./extern.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org401ff03}]{Defined Intrinsics}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org35aec9f}]{Hand-Written Models: Built-In}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org2884e22}]{Hand-Written Models: External}
\begin{center}
\includegraphics[width=.9\linewidth]{./handwritten.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org3b420a4}]{Generated Models: Defined}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc1182df}]{Testing!}
\begin{center}
\includegraphics[width=.9\linewidth]{./tests.png}
\end{center}
\end{frame}
\section{Results}
\label{sec:org8f14383}
\begin{frame}[label={sec:orgd2f5355}]{Acceptance of Solution by AWS}
\begin{center}
\includegraphics[width=.9\linewidth]{./aws.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orge8963de}]{Finding a Bug in Rust}
\begin{center}
\includegraphics[width=.9\linewidth]{./pr.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org33be799}]{Future Work}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd4e7e35}]{Concluding}

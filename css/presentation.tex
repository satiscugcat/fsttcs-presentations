...
\label{sec:org9dab22e}
\begin{frame}[label={sec:org8bc85bd}]{Acknowledgements}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:orgb08d118}]{SIMD and Vector Intrinsics}
...
\end{frame}
\begin{frame}[label={sec:org36c7b21},fragile]{SIMD in Rust}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org935c1a0}]{Importance}
...
\label{sec:orgbdec3d3}
\begin{frame}[label={sec:orgd06690c}]{Rust Docs}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgfeef13d}]{ARM Docs}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org7dc65c2},fragile]{panic!()}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgf6d1439},fragile]{A Bug in the Rust Source????}
 \pause
...
\end{frame}
\begin{frame}[label={sec:org4fec1eb}]{The Moral of the Story}
...
\label{sec:orgd1a85c5}
\begin{frame}[label={sec:org47029b6}]{The Problem}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9016e10}]{Rewrite it .. in Rust!}
\pause
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb7c7244}]{Model Generation}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8a0f1f0}]{Built-In Intrinsics}
\begin{center}
\includegraphics[width=.9\linewidth]{./simd.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgddb4a52}]{External Intrinsics}
\begin{center}
\includegraphics[width=.9\linewidth]{./extern.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org1116c39}]{Defined Intrinsics}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgf89426b}]{Hand-Written Models: Built-In}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org2d8b81f}]{Hand-Written Models: External}
\begin{center}
\includegraphics[width=.9\linewidth]{./handwritten.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org9de3d88}]{Generated Models: Defined}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orga6c24a0}]{Testing!}
\begin{center}
\includegraphics[width=.9\linewidth]{./tests.png}
\end{center}
\end{frame}
\section{Results}
\label{sec:org91e273e}
\begin{frame}[label={sec:org7720691}]{Acceptance of Solution by AWS}
\begin{center}
\includegraphics[width=.9\linewidth]{./aws.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd8b3fb2}]{Finding a Bug in Rust}
\begin{center}
\includegraphics[width=.9\linewidth]{./pr.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org0ade2b5}]{Future Work}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1a8f791}]{Concluding}
...
You can find the content of this talk at \alert{\href{https://github.com/satiscugcat/fsttcs-presentations}{satiscugcat/fsttcs-presentations}}.
Finally, at IIT Gandhinagar, I am organising a student group gor PL work called \alert{,$\backslash$\ AMBDA.}  If that sounds interesting to you and you want to be involved/collaborate, please do reach out! My email is \alert{\href{mailto:aniket.mishra@iitgn.ac.in}{aniket.mishra@iitgn.ac.in}}.
\end{frame}
\end{document}

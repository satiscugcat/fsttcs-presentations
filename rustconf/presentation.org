...
** The Moral of the Story
   ...
   Essentially, bad documentation means that even the best Rust programmers need to wade through Intel or ARM assembly documentation (and more!) to understand these intrinsics. \pause This especially hampers *Formal Verification!*
   + HACL-STAR (F*)
   + Jasmin (Easy Crypt)
...
** Formal Verification
   ...
   + HACL-STAR (which writes its models in F*)
   + Jasmin (which uses Easy Crypt)
   + s2n-bignum (HOL Light)
...
** Concluding
   ...
   You can find the content of this talk at *[[https://github.com/satiscugcat/fsttcs-presentations][satiscugcat/fsttcs-presentations]]* in the *rustconf* branch.
   Finally, at IIT Gandhinagar, I am organising a student group for PL work called *,\\ AMBDA.*  If that sounds interesting to you and you want to be involved/collaborate, please do reach out! My email is *[[mailto:aniket.mishra@iitgn.ac.in][aniket.mishra@iitgn.ac.in]]*.

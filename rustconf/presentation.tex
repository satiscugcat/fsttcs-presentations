...
\title{Formally Specifying the Rust Core}
\hypersetup{
 pdfauthor={Aniket Mishra},
 pdftitle={Formally Specifying the Rust Core},
...
\label{sec:orgc9d1ff2}
\begin{frame}[label={sec:org0aeeeb7}]{Acknowledgements}
\begin{center}
...
\end{frame}
\begin{frame}[label={sec:org20996d8}]{SIMD and Vector Intrinsics}
...
\end{frame}
\begin{frame}[label={sec:orgd054ac3},fragile]{SIMD in Rust}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgfaf6f56}]{Importance}
...
\label{sec:orgaf167db}
\begin{frame}[label={sec:org468d2b5}]{Rust Docs}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org60b5882}]{ARM Docs}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb028039},fragile]{panic!()}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org4778664},fragile]{A Bug in the Rust Source????}
 \pause
...
\end{frame}
\begin{frame}[label={sec:org9e8e23d}]{The Moral of the Story}
Essentially, bad documentation means that even the best Rust programmers need to wade through Intel or ARM assembly documentation (and more!) to understand these intrinsics. \pause This especially hampers \alert{Formal Verification!}
\end{frame}
\begin{frame}[label={sec:orgaca167e}]{Formal Verification}
Formal Verification involves building mathematical models of programs, and implementing and verifying these approach using software. \pause Projects that employ formal verification include:
\begin{itemize}
\item HACL-STAR (which writes its models in F*)
\item Jasmin (which uses Easy Crypt)
\item s2n-bignum (HOL Light)
\end{itemize}
\pause However, since SIMD intrinsics are "outside" of the semantics of the Rust language, modelling their behaviour is difficult.
\end{frame}
\section{Our Solution}
\label{sec:orge86f0c1}
\begin{frame}[label={sec:org920c605}]{The Problem}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga948bef}]{Rewrite it .. in Rust!}
\pause
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org795b0e7}]{Model Generation}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org791bbac}]{Built-In Intrinsics}
\begin{center}
\includegraphics[width=.9\linewidth]{./simd.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org8dda039}]{External Intrinsics}
\begin{center}
\includegraphics[width=.9\linewidth]{./extern.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org2e171d3}]{Defined Intrinsics}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org2e35e2a}]{Hand-Written Models: Built-In}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org1edc95b}]{Hand-Written Models: External}
\begin{center}
\includegraphics[width=.9\linewidth]{./handwritten.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org3b06469}]{Generated Models: Defined}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org89c9b03}]{Testing!}
\begin{center}
\includegraphics[width=.9\linewidth]{./tests.png}
\end{center}
\end{frame}
\section{Results}
\label{sec:orga1124bc}
\begin{frame}[label={sec:orgf2c0f17}]{Acceptance of Solution by AWS}
\begin{center}
\includegraphics[width=.9\linewidth]{./aws.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orga0be067}]{Finding a Bug in Rust}
\begin{center}
\includegraphics[width=.9\linewidth]{./pr.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org65bdff5}]{Future Work}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgef13f5f}]{Concluding}
That is all. Thank you for coming to my talk! I hope it was somewhat informative.
If you want to get in contact with CRYSPEN, you can do so via the \alert{\href{https://cryspen.com/}{website}}.
You can find the content of this talk at \alert{\href{https://github.com/satiscugcat/fsttcs-presentations}{satiscugcat/fsttcs-presentations}} in the \alert{rustconf} branch.
Finally, at IIT Gandhinagar, I am organising a student group for PL work called \alert{,$\backslash$\ AMBDA.}  If that sounds interesting to you and you want to be involved/collaborate, please do reach out! My email is \alert{\href{mailto:aniket.mishra@iitgn.ac.in}{aniket.mishra@iitgn.ac.in}}.
\end{frame}
\end{document}

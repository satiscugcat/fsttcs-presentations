...
\label{sec:org5c9a535}
\begin{frame}[label={sec:org7d63c52},fragile]{An Illustrative Example}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orge5f7588}]{An Exploit}
Let's say the password is \alert{101010}, an exploit may look like the following.
\begin{example}[An Attack Trace]\label{sec:org273fbd1}
...
\end{example}
\end{frame}
\begin{frame}[label={sec:orgb814ad7}]{Threat Model}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org40439df}]{Expression Semantics}
\begin{center}
\includegraphics[width=.9\linewidth]{./expr.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org241648b}]{Command Semantics}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org4a0d31d}]{Debranch Semantics: The Basics}
\begin{center}
\includegraphics[width=.9\linewidth]{./basics_d.png}
\end{center} 
\end{frame}
\begin{frame}[label={sec:org8e4bf88}]{Debranch Semantics: IFs}
\begin{center}
\includegraphics[width=.9\linewidth]{./ifs.png}
\end{center}
\end{frame}
\section{Interactive Theorem Proving - What's the Fuss About?}
\label{sec:org95f7580}
\begin{frame}[label={sec:orgdec4948}]{ITPs}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgcd555b6}]{Expressing Mathematical Structures}
\begin{center}
\includegraphics[width=.9\linewidth]{./simple.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgdfeb743}]{Why Bother?}
...
\label{sec:org0f27c9c}
\begin{frame}[label={sec:org88be208}]{Expressing Grammars}
\begin{center}
\includegraphics[width=.9\linewidth]{./grammar.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org51f39ce}]{Expressing Semantics}
\begin{center}
\includegraphics[width=.9\linewidth]{./semantics.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orga51aa70}]{Expressing Invariants}
\begin{center}
\includegraphics[width=.9\linewidth]{./invariant.png}
\end{center}
\end{frame}
\section{Interactive Theorem Proving - An Undegraduate Perspective}
\label{sec:orgdff5dac}
\begin{frame}[label={sec:org055ef5d}]{Why Did I Bother?}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org571d769}]{Learning to write Rocq vs Learning to write Proofs}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6f9a95d}]{Intuition}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb3353ff}]{Intuition in ITPs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org055ef7d}]{Costs and Caveats}
\pause
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org22751ad}]{Concluding}

...
\label{sec:org4c7d4b8}
\begin{frame}[label={sec:org195457d},fragile]{An Illustrative Example}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgd41a268}]{An Exploit}
Let's say the password is \alert{101010}, an exploit may look like the following.
\begin{example}[An Attack Trace]\label{sec:org6e68a89}
...
\end{example}
\end{frame}
\begin{frame}[label={sec:orgcef002d}]{Threat Model}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgcf3daff}]{Expression Semantics}
\begin{center}
\includegraphics[width=.9\linewidth]{./expr.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org5eb9c7e}]{Command Semantics}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga8a81af}]{Debranch Semantics: The Basics}
\begin{center}
\includegraphics[width=.9\linewidth]{./basics_d.png}
\end{center} 
\end{frame}
\begin{frame}[label={sec:org6f6b864}]{Debranch Semantics: IFs}
\begin{center}
\includegraphics[width=.9\linewidth]{./ifs.png}
\end{center}
\end{frame}
\section{Interactive Theorem Proving - What's the Fuss About?}
\label{sec:org0e0cb69}
\begin{frame}[label={sec:orgc7c8d3c}]{ITPs}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf88ca47}]{Expressing Mathematical Structures}
\begin{center}
\includegraphics[width=.9\linewidth]{./simple.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org0bc349f}]{Why Bother?}
...
\label{sec:orgfea8fb5}
\begin{frame}[label={sec:org6ccde10}]{Expressing Grammars}
\begin{center}
\includegraphics[width=.9\linewidth]{./grammar.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org380c01e}]{Expressing Semantics}
\begin{center}
\includegraphics[width=.9\linewidth]{./semantics.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org6bd5574}]{Expressing Invariants}
\begin{center}
\includegraphics[width=.9\linewidth]{./invariant.png}
\end{center}
\end{frame}
\section{Interactive Theorem Proving - An Undegraduate Perspective}
\label{sec:orgf200376}
\begin{frame}[label={sec:orgf924c9f}]{Why Did I Bother?}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org615d508}]{Learning to write Rocq vs Learning to write Proofs}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org7085e4f}]{Intuition}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org72af0d2}]{Intuition in ITPs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org21a9e64}]{Costs and Caveats}
\pause
\begin{itemize}

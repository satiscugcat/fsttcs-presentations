...
\label{sec:orgdcfbebf}
\begin{frame}[label={sec:orgdc66c47},fragile]{An Illustrative Example}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orga2cb9bf}]{An Exploit}
Let's say the password is \alert{101010}, an exploit may look like the following.
\begin{example}[An Attack Trace]\label{sec:org63f2a38}
...
\end{example}
\end{frame}
\begin{frame}[label={sec:orgdeaf483}]{Threat Model}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge9b3397}]{Expression Semantics}
\begin{center}
\includegraphics[width=.9\linewidth]{./expr.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org5230c2e}]{Command Semantics}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5577bba}]{Debranch Semantics: The Basics}
\begin{center}
\includegraphics[width=.9\linewidth]{./basics_d.png}
\end{center} 
\end{frame}
\begin{frame}[label={sec:org2571dd6}]{Debranch Semantics: IFs}
\begin{center}
\includegraphics[width=.9\linewidth]{./ifs.png}
\end{center}
\end{frame}
\section{Interactive Theorem Proving - What's the Fuss About?}
\label{sec:orgf720f19}
\begin{frame}[label={sec:orga9e3abe}]{ITPs}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd3fbbba}]{Expressing Mathematical Structures}
\begin{center}
\includegraphics[width=.9\linewidth]{./simple.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orga109190}]{Why Bother?}
...
\label{sec:org9b0fbcc}
\begin{frame}[label={sec:org525750a}]{Expressing Grammars}
\begin{center}
\includegraphics[width=.9\linewidth]{./grammar.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org7d5397e}]{Expressing Semantics}
\begin{center}
\includegraphics[width=.9\linewidth]{./semantics.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orga1df3d8}]{Expressing Invariants}
\begin{center}
\includegraphics[width=.9\linewidth]{./invariant.png}
\end{center}
\end{frame}
\section{Interactive Theorem Proving - An Undegraduate Perspective}
\label{sec:org21d52dc}
\begin{frame}[label={sec:org90ea190}]{Why Did I Bother?}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf35d82c}]{Learning to write Rocq vs Learning to write Proofs}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org617a8ab}]{Intuition}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orged51274}]{Intuition in ITPs}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga66ea96}]{Costs and Caveats}
\pause
\begin{itemize}
